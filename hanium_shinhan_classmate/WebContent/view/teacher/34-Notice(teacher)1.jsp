...
<tfoot>
	...
	<tbody>
		...
		<tr>
			...
			<th style=text-align:center;><a data-ajax="false" href="../teacher/38-Noticedetail(teacher).jsp?idx=<c:out value="${Lists.getClass_ID()}"/>"><c:out value="${Lists.getTitle()}"/></a></th>
